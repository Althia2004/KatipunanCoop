...
const fmt = (n: number) =>
    'Γé▒' + Number(n).toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
...
export default function MemberManagementDashboard({ members }: Props) {
    ...
    // MIGS score ΓÇö use real value from DB
                        ...
                        <>
                            ...
                            <div className="p-6 border-b border-zinc-100">
                                ...
                                <div className="flex flex-wrap gap-2 mt-3">
                                    <span className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ${
                                        ...
                                        {getMigsClass(viewMember) === 'migs' ? 'MIGS Γ£ô' : 'Non-MIGS Γ£ù'}
                                    </span>
                            ...
                            <div className="px-6 py-4 border-b border-zinc-100">
                                ...
                                <p className="text-xs text-zinc-400 mt-1">
                                    {getMigsScore(viewMember) >= 50
                                        ? 'Γ£ô Member is in good standing'
                                        : 'Γ£ù Below minimum score (50)'}
                                </p>
                            </div>
                            ...
                            {/* Membership Information ΓÇö REAL DATA */}
                            <div className="px-6 py-4 border-b border-zinc-100">
                                <p className="text-xs font-semibold uppercase tracking-widest text-zinc-400 mb-3">
                                ...
                                <div className="mt-3 pt-3 border-t border-zinc-100">
                                    <div className={`rounded-xl px-3 py-2 text-xs ${
                                        ...
                                        {(viewMember.share_capital ?? 0) >= 20000
                                            ? 'Γ£ô Meets Γé▒20,000 capital share requirement for loans'
                                            : `ΓÜá Needs Γé▒${(20000 - (viewMember.share_capital ?? 0)).toLocaleString()} more capital share for loan eligibility`}
                                    </div>
                                </div>
                            </div>

                            {/* Loan History ΓÇö REAL DATA */}
                            <div className="px-6 py-4 border-b border-zinc-100">
                                <p className="text-xs font-semibold uppercase tracking-widest text-zinc-400 mb-3">
                                    Loan History
                                </p>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="rounded-xl bg-[#2d5a27]/10 p-3">
                                <span className="text-2xl text-[#2d5a27]">Γ£ô</span>
                            </div>
                        </div>
                    </div>
